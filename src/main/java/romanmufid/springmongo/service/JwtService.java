...
public class JwtService {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        final String fullName = extractFullName(token);
        return (username.equals(userDetails.getUsername()) && fullName.equals(
                ((User) userDetails).getFullName())) && !isTokenExpired(token);
    }
